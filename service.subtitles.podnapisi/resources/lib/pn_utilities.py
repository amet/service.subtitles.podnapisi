...
SEARCH_URL_HASH   = "http://beta.podnapisi.net/ppodnapisi/search?tbsl=1&sK=%s&sJ=%s&sY=%s&sTS=%s&sTE=%s&sMH=%s&sXML=1&lang=0"
SEARCH_URL        = "http://beta.podnapisi.net/ppodnapisi/search?tbsl=1&sK=%s&sJ=%s&sY=%s&sTS=%s&sTE=%s&sXML=1&lang=0"

DOWNLOAD_URL      = "http://beta.podnapisi.net/subtitles/%s/download"
